...
def do_train_stage1(cfg,
 ...
 #           import pdb
 #           pdb.set_trace()
            loss_i2t = xent(image_features, text_features[0], target, target)
            loss_t2i = xent(text_features[0], image_features, target, target)
#            loss_multi=multip(image_features, target, plat, text_features)
#            platloss=plat(image_features, target, plat, text_features)
           
            lossjoint=symmetric_clip_loss_batch_pairing(image_features, text_features[1])
