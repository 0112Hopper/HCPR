...
class build_transformer(nn.Module):
    ...
    def forward(self, x = None, label=None, platform=None,get_image = False, get_text = False, cam_label= None, view_label=None,img_features = None):
...
#            return text_features
        if get_text == True:
            ...
            text_features = self.text_encoder(prompts, [self.prompt_learner.tokenized_person,self.prompt_learner.tokenized_joint])
            return text_features
